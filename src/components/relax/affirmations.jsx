    ...
    return (
        ...
        <div>
            ...
            <div className='about-aff'>
                ...
                <div>Afirmacje są krótkimi podstawowymi założeniami deklaracjami, przekonaniami, zdaniami, aprobatami, które wyrażają postawę lub przekonanie na temat siebie, lub okoliczności swojego życia. Są podstawą codziennego myślenia, od którego wszystko się zaczyna. Sposób, w jaki myślisz o sobie, innych ludziach, wydarzeniach i świecie, jest tym, jak się czujesz. To, jak się czujesz, jest tym, jak się zachowujesz.</div>
                <div>Gdy ktoś pyta, czy afirmacje dla dzieci w ogóle mają sens, odpowiadamy tak: słowa przekładają się na myśli, myśli wpływają na uczucia, uczucia – na zachowania, zachowania zmieniają się w nawyki, a te kształtują całe życie. Więc tak: afirmacje dla dzieci są potężnym narzędziem, które już od najmłodszych lat kierunkuje człowieka na rozwój, trwanie w pozytywnych wibracjach i odczuwanie wdzięczności zamiast presji. Zobacz, jakie afirmacje dla dzieci warto stosować.</div>
            </div>     
        </div>
