    ...
    return (
        ...
        <div className="mind-section">
            ...
            <div className="mind-box">
                ...
                <div className="mind-description">Znajdź coś mocno pachnącego, na przykład świeżą skórkę z pomarańczy, laskę cynamonu, czy wanilii. Poproś dzieci, żeby zamknęły oczy i wdychały zapach, skupiając na nim całą uwagę.Dzieci z zamkniętymi oczami smakują rodzynkę, starając się jeść ją jak najdłużej, zwracając uwagę na wszystkie odcienie smaku. </div>
            </div>
            <div className="mind-box">
                <div className="mind-title-container">
                <p className="mind-title">Oddychanie z małym przyjacielem</p>
            ...
            <div className="mind-box">
                ...
                <div className="mind-description">Dzieci leżąc na podłodze z zamkniętymi oczami starają się napiąć każdy mięsień w ciele tak mocno, jak tylko potrafią. Palce u nóg i stopy, nogi, brzuch. Mogą zacisnąć pięści i podnieść ręce do głowy. Pozostają w tej ściśniętej pozycji przez kilka sekund a potem w pełni się rozluźniają i relaksują.</div>
            </div>
            <div className="mind-box">
                <div className="mind-title-container">
                <p className="mind-title">Oddychanie z małym przyjacielem</p>
